        ...
        <h3>AVAILABLE DEPARTMENTS:</h3>
            <?php
                    ...
                    <table style="margin: 10px;">
                        <tr>
                            <td style="padding: 10px;" >DEPARTMENT ID: <p style="color: green;display:inline-block;"> <?php echo $data['department_id'] ?></p></td>
                        </tr>
                        <tr>
                            <td style="padding: 10px;" >DEPARTMENT NAME: <p style="color: green;display:inline-block;"> <?php echo $data['department_name'] ?></p> </td>
                        </tr>
                    </table> 
                    </span>
                    <?php
